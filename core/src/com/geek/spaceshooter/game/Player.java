...
public class Player extends Ship {
    ...
    public Player(com.geek.spaceshooter.game.screens.GameScreen game, TextureRegion texture, TextureRegion textureHP, TextureRegion textureJoystick, Sound fireSound, Vector2 position, Vector2 velocity, float engine) {
        this.game = game;
